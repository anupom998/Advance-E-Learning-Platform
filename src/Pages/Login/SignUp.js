    ...
    return (
        <section>
            <div className='grid grid-cols-1 md:grid-cols-12'>
                ...
                {/*left content  */}
                <div className=' h-full w-full bg-signIn px-20 flex flex-col md:col-span-5'>
                    {/* logo */}
                    ...
                    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
                            ...
                            <p className="text-start text-sm text-gray-500">
                                New User ? {''}
                                <NavLink to="/uganda" className="font-semibold underline leading-6 text-indigo-600 hover:text-indigo-500">
                                    Create an Account
                                </NavLink>
                            </p>
                        </div>
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form action="#" method="POST" className="space-y-6">
                                ...
                                <div className="text-sm">
                                    <NavLink to="#" className="font-semibold underline text-indigo-600 hover:text-gray-500">
                                        Forgot password?
                                    </NavLink>
                                </div>
                                <div>
